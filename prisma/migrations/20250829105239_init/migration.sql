-- CreateEnum
CREATE TYPE "GameMode" AS ENUM ('SR_5v5', 'SR_4v4', 'SR_3v3', 'SR_2v2', 'SR_1v1', 'ARAM', 'TFT');

-- CreateEnum
CREATE TYPE "LobbyState" AS ENUM ('CREATED', 'CONFIGURED', 'PICKING', 'SCHEDULED', 'RUNNING', 'FINISHED', 'CLEANED');

-- CreateEnum
CREATE TYPE "MatchState" AS ENUM ('PENDING', 'SENT', 'RUNNING', 'DONE');
